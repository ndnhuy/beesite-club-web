...
angular
    .module('app.core')
    .controller('MemberController', function($window, $scope, $log, membersJSON, $cookies, AuthService) {
        var vm = this;
        
        vm.members = membersJSON.data.data;
        $log.info("Members: " + JSON.stringify(vm.members));
