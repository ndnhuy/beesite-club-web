...
angular
    .module('app.core')
    .controller('ArticleManagementController', function($window, $scope, $cookies, AuthService, $log, articles, ArticleService) {
        var vm = this;
        
        vm.articles = articles.data.data;        

        vm.deleteArticleById = function(id) {
            ArticleService.deleteArticleById(id).then(function(data) {
